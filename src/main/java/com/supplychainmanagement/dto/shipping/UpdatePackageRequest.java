 ...
 * Replaces every field, with the defaults a new package gets: no type means OTHER, no weight means 0.
 * Only the package number is kept when left out, since a printed label may already carry it.
 */
