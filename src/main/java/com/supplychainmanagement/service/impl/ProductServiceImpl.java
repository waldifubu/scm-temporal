...
public class ProductServiceImpl implements ProductService {
    ...
    public Mono<Product> findById(Long id) {
        return Mono.fromCallable(() -> productRepository.findWithComponentsById(id)
    ...
    public Mono<Product> update(Long id, Product product) {
        return Mono.fromCallable(() -> {
                    ...
                    existingProduct.setComponents(product.getComponents());
                    bindComponentsToProduct(existingProduct, existingProduct.getComponents());
